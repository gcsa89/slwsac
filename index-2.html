...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul>
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="2500" data-delay="5000">
                            ...
                            <div class="tp-caption sfb custom-font-2"
                                ...
                                data-start="1400"
                                data-easing="easeInOutCubic">
                                We Deliver Low Cost Cargo Services
                            </div>
        ...
        <div id="content" class="no-padding">
                ...
                <div class="container">
                    <div class="row">
                        <div class="text-center">
                            <h2 class="wow fadeInUp" data-wow-delay="0">Welcome
                        ...
                        <div class="col-md-4">
                            <img src="img/misc/pic%20(1).jpg" alt="" class="img-responsive wow fadeInUp" data-wow-delay="0s">
                            <h3 class="wow fadeInUp" data-wow-delay=".7s">See Our Branch Office</h3>
                            <p class="wow fadeInUp" data-wow-delay=".8s">The word cargo refers in particular to goods or produce being conveyed generally for commercial gain by ship, boat, or aircraft, although the term is now often extended to cover all types of freight.</p>
                        </div>

                        <div class="col-md-4">
                            <img src="img/misc/pic%20(2).jpg" alt="" class="img-responsive wow fadeInUp" data-wow-delay=".3s">
                            <h3 class="wow fadeInUp" data-wow-delay=".9s">Estimate Shipping Cost</h3>
                            <p class="wow fadeInUp" data-wow-delay="1s">The word cargo refers in particular to goods or produce being conveyed generally for commercial gain by ship, boat, or aircraft, although the term is now often extended to cover all types of freight.</p>
                        </div>

                        <div class="col-md-4">
                            <img src="img/misc/pic%20(3).jpg" alt="" class="img-responsive wow fadeInUp" data-wow-delay=".6s">
                            <h3 class="wow fadeInUp" data-wow-delay="1.1s">Mobile Tracking</h3>
                            <p class="wow fadeInUp" data-wow-delay="1.2s">The word cargo refers in particular to goods or produce being conveyed generally for commercial gain by ship, boat, or aircraft, although the term is now often extended to cover all types of freight.</p>
                        </div>
			...
			<!-- section begin -->
            <section id="section-services" class="bg-grey">
                <div class="container">
                    <div class="row">
                        <div class="text-center">
                            <h2 class="wow fadeInUp" data-wow-delay="0">Our Services
							<span>We Serve All Industry</span>
                            </h2>
                            <div class="small-border wow flipInY" data-wow-delay=".2s" data-wow-duration=".8s"></div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="logo-partners">
                            <div class="col-md-2 col-xs-4">
                                <img class="wow fadeInRight" data-wow-delay=".2s" data-wow-duration=".6s" src="img/logo/1.jpg" alt="">
                            </div>

                            <div class="col-md-2 col-xs-4">
                                <img class="wow fadeInRight" data-wow-delay=".5s" data-wow-duration=".5s" src="img/logo/2.jpg" alt="">
                            </div>

                            <div class="col-md-2 col-xs-4">
                                <img class="wow fadeInRight" data-wow-delay=".8s" data-wow-duration=".5s" src="img/logo/3.jpg" alt="">
                            </div>

                            <div class="col-md-2 col-xs-4">
                                <img class="wow fadeInRight" data-wow-delay="1.1s" data-wow-duration=".5s" src="img/logo/4.jpg" alt="">
                            </div>

                            <div class="col-md-2 col-xs-4">
                                <img class="wow fadeInRight" data-wow-delay="1.4s" data-wow-duration=".5s" src="img/logo/5.jpg" alt="">
                            </div>

                            <div class="col-md-2 col-xs-4">
                                <img class="wow fadeInRight" data-wow-delay="1.7s" data-wow-duration=".5s" src="img/logo/6.jpg" alt="">
                            </div>
                        </div>
